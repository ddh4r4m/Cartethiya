...
Rectangle {
    ...
    property var user: userModel
    property int lastIndexUser: userModel.lastIndex
    ...
    Connections {
        ...
        function onLoginSucceeded() {
            // Your login success handling here
        }
    ...
    Rectangle {
        ...
        Rectangle {
            ...
            anchors.horizontalCenter: parent.horizontalCenter
            anchors.top: parent.top
            anchors.topMargin: parent.height * 0.04  // 15% from top
            color: "transparent"
            Item {
                id: clockContainer
                width: parent.width
